...
<head>
    ...
    <title><?php echo e(config('app.name', 'GesVitalPro')); ?> - Sistema de Gestión Médica</title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/sb-admin-pro.css')); ?>">
...
<body>
                    ...
                    <?php if(Route::has('login')): ?>
                        ...
                        <?php else: ?>
                            ...
                            <?php if(Route::has('register')): ?>
                                <li class="nav-item">
                                    <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-light ms-3">Registrarse</a>
                                </li>
                            <?php endif; ?>
                        <?php endif; ?>
                    <?php endif; ?>
                ...
                <div class="col-lg-8 col-xl-7 col-xxl-6">
                    <div class="my-5 text-center text-xl-start text-white">
                        ...
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                            <a class="btn btn-white btn-lg px-4 me-sm-3" href="<?php echo e(route('login')); ?>">Comenzar</a>
    ...
    <footer class="py-4 bg-dark">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                    <div class="small text-white">Copyright &copy; GesVitalPro <?php echo e(date('Y')); ?></div>
                </div>
                <div class="col-auto">
    ...
    <script src="<?php echo e(asset('js/sb-admin-pro.js')); ?>"></script>
</body>
</html><?php /**PATH C:\xampp\htdocs\NvoGestionv2\NvoGestion\resources\views/welcome-pro.blade.php ENDPATH**/ ?>